...
UAVOBJ_TARGETS := gcs flight python matlab java wireshark pythonflight
...
ALL_BOARDS    := coptercontrol oplinkmini revolution osd revoproto simposix raspberrypilot

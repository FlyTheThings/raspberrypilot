...
#define PIOS_HMC5883_CONFIG_REG_A			0x00
#define PIOS_HMC5883_CONFIG_REG_B			0x01
#define PIOS_HMC5883_MODE_REG				0x02
...
/* Output Data Rate */
#define PIOS_HMC5883_ODR_0_75				0 << 2
#define PIOS_HMC5883_ODR_1_5				1 << 2
#define PIOS_HMC5883_ODR_3					2 << 2
#define PIOS_HMC5883_ODR_7_5				3 << 2
#define PIOS_HMC5883_ODR_15					4 << 2
#define PIOS_HMC5883_ODR_30					5 << 2
#define PIOS_HMC5883_ODR_75					6 << 2

/* Measure configuration */
#define PIOS_HMC5883_MEASCONF_NORMAL		0 << 0
#define PIOS_HMC5883_MEASCONF_BIAS_POS		1 << 0
#define PIOS_HMC5883_MEASCONF_BIAS_NEG		2 << 0

/* Gain settings */
#define PIOS_HMC5883_GAIN_0_88				0 << 5
#define PIOS_HMC5883_GAIN_1_3				1 << 5 // (default)
#define PIOS_HMC5883_GAIN_1_9				2 << 5
#define PIOS_HMC5883_GAIN_2_5				3 << 5
#define PIOS_HMC5883_GAIN_4_0				4 << 5
#define PIOS_HMC5883_GAIN_4_7				5 << 5
#define PIOS_HMC5883_GAIN_5_6				6 << 5
#define PIOS_HMC5883_GAIN_8_1				7 << 5 // NOT RECOMMENDED?

/* Modes */
#define PIOS_HMC5883_MODE_CONTINUOUS		0 << 0
#define PIOS_HMC5883_MODE_SINGLE			1 << 0
#define PIOS_HMC5883_MODE_IDLE				2 << 0
#define PIOS_HMC5883_MODE_SLEEP				3 << 0

/* Sensitivity Conversion Values */
#define PIOS_HMC5883_Sensitivity_0_88Ga		1370	// LSB/Ga
#define PIOS_HMC5883_Sensitivity_1_3Ga		1090	// LSB/Ga (default)

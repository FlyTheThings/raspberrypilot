...
#define PIOS_BMP180_ID									0x55	// Identification value
		...
		#define PRESSURE_WAITING_TIME PIOS_BMP180_ULTRA_LOW_POWER_PRES_WAIT_us
	
#elif	PIOS_BMP180_OSS == PIOS_BMP180_STANDARD_MODE
		#define PRESSURE_WAITING_TIME PIOS_BMP180_STANDARD_PRES_WAIT_us
	
#elif	PIOS_BMP180_OSS == PIOS_BMP180_HIGH_RESOLUTION_MODE
		#define PRESSURE_WAITING_TIME PIOS_BMP180_HIGH_RESOLUTION_PRES_WAIT_us
	
#elif	PIOS_BMP180_OSS == PIOS_BMP180_ULTRA_HIGH_RESOLUTION_MODE
		#define PRESSURE_WAITING_TIME PIOS_BMP180_ULTRA_HIGH_RESOLUTION_PRES_WAIT_us
#endif
